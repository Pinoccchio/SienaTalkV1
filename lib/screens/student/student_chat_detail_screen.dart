    ...
    _messagesChannel = _supabase
        ...
        callback: (payload) {
          if (payload.newRecord != null) {
            ...
            // Only add message if it's relevant to this chat and not from current user
            // (we already add current user messages immediately on send)
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          if (isMe)
            const SizedBox(width: 16), // Space for avatar on the right side
        ],
      ),
    );
  }
